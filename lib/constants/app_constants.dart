class AppConstants {
  ...
  static const List<String> navigationSubtitles = [
  ...
  // Heart icon SVG
  static const String heartIconSvg = '''<svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
